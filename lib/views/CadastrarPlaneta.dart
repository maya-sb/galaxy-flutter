    ...
    return Container(
          ...
          children: <Widget>[
             Padding(
               ...
               child: EditField(title: "Nome", controller: nomeController, validator: validatorNome),
             ),  
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: EditField(title: "Tamanho", controller: tamanhoController, validator: validatorNome),
            ),
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: EditField(title: "Massa", controller: massaController, validator: validatorNome),
            ),
            Padding(
               padding: const EdgeInsets.all(8.0),
               child: EditField(title: "Velocidade de Rotação", controller: velocidadeController, validator: validatorNome),
            ),   
